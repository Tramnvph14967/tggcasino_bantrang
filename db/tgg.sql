...
-- Thời gian đã tạo: Th9 11, 2023 lúc 10:06 AM
...
(1, 'Super Admin', 'temisvietnam@gmail.com', 'tggcasino', NULL, '6238276ac25d11647847274.png', '$2y$10$qaZRD47K8YfpEPyQeDlqvuPiIxTx0YE727tO5CnXWTBdigr2slzji', '6F8QFFrA7Zwqu2cBgoMWu4AtpvkF9MRi7aCAp7CvJJd6tvje7rkLw3hvkSEO', NULL, '2023-07-05 12:16:08');
...
--
-- Cấu trúc bảng cho bảng `bet_details`
--
...
(2, 'google-recaptcha2', 'Google Recaptcha 2', 'Key location is shown bellow', 'recaptcha3.png', '\n<script src=\"https://www.google.com/recaptcha/api.js\"></script>\n<div class=\"g-recaptcha\" data-sitekey=\"{{site_key}}\" data-callback=\"verifyCaptcha\"></div>\n<div id=\"g-recaptcha-error\"></div>', '{\"site_key\":{\"title\":\"Site Key\",\"value\":\"6LdPC88fAAAAADQlUf_DV6Hrvgm-pZuLJFSLDOWV\"},\"secret_key\":{\"title\":\"Secret Key\",\"value\":\"6LdPC88fAAAAAG5SVaRYDnV2NpCrptLg2XLYKRKB\"}}', 'recaptcha.png', 0, '2019-10-18 23:16:05', '2023-04-30 06:10:38'),
...
(1, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"bet\",\"betting\",\"sports betting\",\"spobet\",\"odds\",\"oddsrate\"],\"description\":\"Welcome to our sports betting platform. Explore a wide array of thrilling sports events and bet on your favorite teams to win big. Our user-friendly interface ensures a seamless experience, with secure transactions.\",\"social_title\":\"BetLab - Sports Betting Platform\",\"social_description\":\"Welcome to our sports betting platform. Explore a wide array of thrilling sports events and bet on your favorite teams to win big. Our user-friendly interface ensures a seamless experience, with secure transactions.\",\"image\":\"64c5311c5c5011690644764.png\"}', '2020-07-04 23:42:52', '2023-07-29 15:32:44'),
...
(2, 0, 102, 'Perfect Money', 'PerfectMoney', 1, '{\"passphrase\":{\"title\":\"ALTERNATE PASSPHRASE\",\"global\":true,\"value\":\"hR26aw02Q1eEeUPSIfuwNypXX\"},\"wallet_id\":{\"title\":\"PM Wallet\",\"global\":false,\"value\":\"\"}}', '{\"USD\":\"$\",\"EUR\":\"\\u20ac\"}', 0, NULL, NULL, '2019-09-14 07:14:22', '2021-05-20 19:35:33'),
...
(37, 0, 120, 'Authorize.net', 'Authorize', 1, '{\"login_id\":{\"title\":\"Login ID\",\"global\":true,\"value\":\"59e4P9DBcZv\"},\"transaction_key\":{\"title\":\"Transaction Key\",\"global\":true,\"value\":\"47x47TJyLw2E7DbR\"}}', '{\"USD\":\"USD\",\"CAD\":\"CAD\",\"CHF\":\"CHF\",\"DKK\":\"DKK\",\"EUR\":\"EUR\",\"GBP\":\"GBP\",\"NOK\":\"NOK\",\"PLN\":\"PLN\",\"SEK\":\"SEK\",\"AUD\":\"AUD\",\"NZD\":\"NZD\"}', 0, NULL, NULL, NULL, '2022-08-28 03:33:06'),
...
--
-- Cấu trúc bảng cho bảng `leagues`
--
...
(18, 'BET_REFUNDED', 'Bet Refunded', 'Your bet has been refunded', 'Hello {{username}},<div><br><div>Your bet has been refunded.</div><div>You Bet Id: {{bet_number}}</div><div>Refund Amount: {{amount}} {{site_currency}}</div><div><br></div></div>', 'Hello {{username}},\r\n\r\nYour bet has been refunded.\r\nYou Bet Id: {{bet_number}}\r\nRefund Amount: {{amount}} {{site_currency}}', '{\"username\":\"Bet place username\",\"amount\":\"Bet stake amount\",\"bet_number\":\"Bet Number\"}', 1, 1, NULL, '2023-05-09 12:01:39'),
(19, 'BET_WIN', 'Bet Win', 'You won the bet successfully', 'Hello {{username}},<div><br><div>You won the bet successfully.</div><div>You Bet Number: {{bet_number}}</div><div>Win Amount: {{amount}} {{site_currency}}</div><div><br></div></div>', 'Hello {{username}},\r\n\r\nYou won the bet successfully\r\nYou Bet Number: {{bet_number}}\r\nWin Amount: {{amount}} {{site_currency}}', '{\"username\":\"Bet place username\",\"amount\":\"Bet stake amount\",\"bet_number\":\"Bet Number\"}', 1, 1, NULL, '2023-04-11 08:44:06'),
(20, 'BET_LOSE', 'Bet Lose', 'You lost the bet', 'Hello {{username}},<div><br><div>You lost the bet.</div><div>You Bet Number: {{bet_number}}</div><div>Lose Amount: {{amount}} {{site_currency}}</div><div><br></div></div>', 'Hello {{username}},\r\n\r\nYou lost the bet\r\nYou Bet Number: {{bet_number}}\r\nLose Amount: {{amount}} {{site_currency}}', '{\"username\":\"Bet place username\",\"amount\":\"Bet stake amount\",\"bet_number\":\"Bet Number\"}', 1, 1, NULL, '2023-04-11 08:44:06'),
(21, 'REFERRAL_COMMISSION', 'Referral Commissoin', 'You have got referral commission', 'Hello {{username}},<div>You have got {{commission_type}} referral commission {{amount}} {{site_currency}} from {{referral_user}}.</div><div>Transaction : {{trx}}</div><div>Commission Level : {{level}}</div><div>Commission Percent : {{commission_percent}}</div><div><br></div>', 'Hello {{username}},\r\nYou have got {{commission_type}} referral commission {{amount}} {{site_currency}} from {{referral_user}}.', '{\"username\":\"Referred username\",\"amount\":\"Amount of Commission\",\"trx\":\"Transaction Number\",\"commission_type\":\"Commission Type\",\"level\":\"Commission Level\",\"commission_percent\":\"Commission Percentage\",\"referral_user\":\"Referral Commission form Referral User\"}', 1, 1, NULL, '2023-04-30 07:11:50');
...
--
-- Cấu trúc bảng cho bảng `referral_settings`
--
...
--
-- Cấu trúc bảng cho bảng `update_logs`
--
...
--
-- Chỉ mục cho bảng `bets`
--
ALTER TABLE `bets`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `bet_details`
--
...
--
-- Chỉ mục cho bảng `referral_settings`
--
...
--
-- AUTO_INCREMENT cho bảng `bets`
--
ALTER TABLE `bets`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `bet_details`
--
ALTER TABLE `bet_details`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `leagues`
--
ALTER TABLE `leagues`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `referral_settings`
--
ALTER TABLE `referral_settings`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `update_logs`
--
ALTER TABLE `update_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
